...
<blockquote expandable>  ɪ ᴀᴍ ᴀɴ ᴀᴅᴠᴀɴᴄᴇ ғɪʟᴇ sʜᴀʀᴇ ʙᴏᴛ.
ɪᴍ ᴏɴʟʏ ғᴏʀ ᴜsᴇ ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴜɴɪᴛʏ ɪɴᴅɪᴀ.</blockquote></b>"""

#Force sub message 
FORCE_MSG = """<b><blockquote>›› Hᴇʏ {mention} ×
      ʏᴏᴜʀ ғɪʟᴇ ɪs ʀᴇᴀᴅʏ ‼️ ʟᴏᴏᴋs ʟɪᴋᴇ ʏᴏᴜ ʜᴀᴠᴇɴ'ᴛ ᴊᴏɪɴ ᴛᴏ ᴏᴜʀ ᴄʜᴀɴɴᴇʟs ʏᴇᴛ, ᴊᴏɪɴ ɴᴏᴡ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇs.</b></blockquote><b>❗Fᴀᴄɪɴɢ ᴘʀᴏʙʟᴇᴍs, ᴜsᴇ: /help </b>"""
...
<blockquote expandable>›› ᴏᴡɴᴇʀ: <a href='tg://openmessage?user_id=6419671110'>Lᴜғғʏ</a></blockquote></b>"""
