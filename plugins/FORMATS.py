...
<blockquote>ɪ ᴀᴍ ᴀɴ ᴀᴅᴠᴀɴᴄᴇ ғɪʟᴇ sʜᴀʀᴇ ʙᴏᴛ.
ɪᴍ ᴏɴʟʏ ғᴏʀ ᴜsᴇ ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴜɴɪᴛʏ ɪɴᴅɪᴀ.</blockquote></b>"""

#Force sub message 
FORCE_MSG = """<b>Hᴇʏ, {mention} ×
         <blockquote>ʏᴏᴜʀ ғɪʟᴇ ɪs ʀᴇᴀᴅʏ ‼️ ʟᴏᴏᴋs ʟɪᴋᴇ ʏᴏᴜ ʜᴀᴠᴇɴ'ᴛ ᴊᴏɪɴ ᴛᴏ ᴏᴜʀ ᴄʜᴀɴɴᴇʟs ʏᴇᴛ, ᴊᴏɪɴ ɴᴏᴡ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇs.. !</blockquote>
...
<blockquote expandable>◈ ᴏᴡɴᴇʀ: <a href='tg://openmessage?user_id=7932127170'>𝗜̸𝘀̸𝘀̸ᴇɪ</a></b></blockquote>"""
