...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8516305012:AAGo1rspCH6-Efsu4YkBznTK-bHhFSGtRzA")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002258370603"))
...
SUPPORT_GROUP = os.environ.get("SUPPORT_GROUP", "https://t.me/Donghuas_Discussion")
...
DB_NAME = os.environ.get("DATABASE_NAME", "Luffybots")
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>\n➥ ᴊᴏɪɴ : <a href='https://t.me/Hindi_Sub_Donghua'>ʜɪɴᴅɪ sᴜʙ ᴅᴏɴɢʜᴜᴀ</a></b>")
