...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002070366722"))

#OWNER ID --⚠️ REQUIRED--
OWNER_ID = int(os.environ.get("OWNER_ID", "8189495654"))
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>\n›› ʙʏ <a href='https://t.me/Anime_Community_India'>ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴜɴɪᴛʏ ɪɴᴅɪᴀ</a></b>")
